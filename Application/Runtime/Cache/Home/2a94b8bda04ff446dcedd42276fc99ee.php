...
<div id="navbar-space"></div>
			...
			<div class="col-md-3">
				<div class="panel panel-default">
				  ...
				  <div class="list-group">
				  	<?php $__FOR_START_1249904946__=0;$__FOR_END_1249904946__=9;for($i=$__FOR_START_1249904946__;$i < $__FOR_END_1249904946__;$i+=1){ ?><a href="#" class="list-group-item category-item"> Cras justo odio </a><?php } ?>
					</div>
				</div>
			</div>
			<!-- 轮播 -->
	...
	<section class="container">
		<div class="row">
			...
			<div class="tab-content" id="xxx-panels">
			  <?php $__FOR_START_687323522__=0;$__FOR_END_687323522__=4;for($i=$__FOR_START_687323522__;$i < $__FOR_END_687323522__;$i+=1){ ?><div role="tabpanel" class="container tab-pane <?php echo ($i==0?'active':''); ?>" id="recommend-tab-<?php echo ($i); ?>">
			  	<div class="row">
			  		<?php $__FOR_START_250050102__=0;$__FOR_END_250050102__=6;for($j=$__FOR_START_250050102__;$j < $__FOR_END_250050102__;$j+=1){ ?><div class="col-md-2 col-xs-4">
	...
	<!-- 列举产品 -->
	<section class="container">
		<?php $__FOR_START_617011463__=0;$__FOR_END_617011463__=3;for($i=$__FOR_START_617011463__;$i < $__FOR_END_617011463__;$i+=1){ ?><div class="row">
			<?php $__FOR_START_1606889418__=0;$__FOR_END_1606889418__=3;for($ii=$__FOR_START_1606889418__;$ii < $__FOR_END_1606889418__;$ii+=1){ ?><div class="col-md-4">
				<div class="panel panel-default">
				  <div class="panel-heading">
				    <a href=""><h3 class="panel-title">xxx类</h3></a>
				  </div>
				  <div class="panel-body">
				  	<?php $__FOR_START_2010203406__=0;$__FOR_END_2010203406__=4;for($iii=$__FOR_START_2010203406__;$iii < $__FOR_END_2010203406__;$iii+=1){ ?><div class="col-md-6  col-xs-6">
